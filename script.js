...
function reveal() {
    var reveals = document.querySelectorAll(".info-flex, .service-card, .section-title, .rating-section");
    reveals.forEach(el => {
...
document.querySelectorAll(".info-flex, .service-card, .section-title, .rating-section").forEach(el => {
    el.style.opacity = '0';
