...
function reveal() {
    var reveals = document.querySelectorAll(".info-flex, .service-card, .section-title, .rating-section, .survey-section, .value-card, .gallery-item");
    reveals.forEach(el => {
...
document.querySelectorAll(".info-flex, .service-card, .section-title, .rating-section, .survey-section, .value-card, .gallery-item").forEach(el => {
    el.style.opacity = '0';
